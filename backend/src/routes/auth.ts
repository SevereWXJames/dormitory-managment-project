...
authRouter.post("/signup", async (req, res) => {
    try{
        ...
        const statusCode = /required|valid email|not match|not found|incorrect password|already exists|failed to create account|unable to update/i.test(message) ? 400 : 500;
